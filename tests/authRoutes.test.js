...
test('POST /recipes creates a new recipe', async () => {
    const response = await request(app)
      .post('/api/recipes')
      .set('Authorization', `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NGNiNGE2MjQ3ZjFkOGUyNDY3MjM0MWIiLCJpYXQiOjE2OTExMjc2NDksImV4cCI6MTY5MTEzNDg0OX0.fBZoGi-DDB8rYLzoux1xRY8JrFd_SiuKKuq2z4grksc`)
      .send({
        name: 'Test Recipe',
        effects: ['Glow'],
